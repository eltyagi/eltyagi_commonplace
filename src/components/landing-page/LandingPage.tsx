  ...
  return (
    <div className="landing-page">
        ...
        <div className = 'pg-links'>
            ...
            <a href="https://www.instagram.com/lakshya.cozi?igsh=N2NsODJ6NHlxdnZn&utm_source=qr" target="_blank" rel="noopener noreferrer" className='pg-link-icon' aria-label="Instagram">
                <InstagramIcon />
            </a>
            <a href="https://www.youtube.com/@lakshya_gits_it-g6i" target="_blank" rel="noopener noreferrer" className='pg-link-icon' aria-label="YouTube">
                <YouTubeIcon />
            </a>
            <a href="https://github.com/eltyagi" target="_blank" rel="noopener noreferrer" className='pg-link-icon' aria-label="GitHub">
                <GitHubIcon />
            </a>
        </div>
